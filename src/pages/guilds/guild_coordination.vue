<template>
  <div>
            ...
            <div class="email-left-aside">
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="email-app-sidebar left-bookmark mt-3">
                    <div class="media">
                      <div class="media-body ml-1">
                        <hr/>
                        <h6 class="f-w-600 mb-4">协调小组事务</h6>
                        <h3>3 件</h3>
                        <small
                          >协调小组若收到越多治理建议，可能需要等待越久才会得到正式答复</small
                        >
                      </div>
                    </div>
    ...
    <button class="btn btn-primary" type="button" data-dismiss="modal">Cancel</button>
                      ...
                      <li class="nav-item">
                        <span class="main-title"><b>业务工作</b></span>
                      </li>
                      <li>
                        <a
                      ...
                      <li>
                        <span class="main-title"> <b>治理工作</b></span>
                      </li>
                      <li>
                        <a
                          class="show"
