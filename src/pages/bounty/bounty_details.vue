              ...
              <div class="card">
                <div class="card-body">
                    <div class="text-center">
                        <img src="https://thumbs.dreamstime.com/b/silhouettes-concert-crowd-front-bright-stage-lights-silhouettes-concert-crowd-front-bright-stage-lights-public-107676956.jpg" />
                    </div>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="filter-block text-center">
                    <b-button variant="primary"  size="lg" >关注活动</b-button>
                  </div>
                </div>
              </div>
              <div class="card">
