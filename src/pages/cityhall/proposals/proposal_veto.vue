<template>
  ...
  <button class="btn btn-primary" type="button" data-dismiss="modal">Cancel</button>
                        ...
                        <li class="nav-item">
                          <span class="main-title"><b>待处理提案</b></span>
                        </li>
                        <li>
                          <a
                        ...
                        <li>
                          <span class="main-title"> <b>提案分类</b></span>
                        </li>
                        <li>
                          <a
                            class="show"
