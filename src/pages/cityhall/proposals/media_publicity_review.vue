<template>
  ...
  <button class="btn btn-primary" type="button" data-dismiss="modal">Cancel</button>
                        ...
                        <li class="nav-item">
                          <span class="main-title"><b>提出申请的项目</b></span>
                        </li>
                        <li>
                          <a
                        ...
                        <li>
                          <span class="main-title"> <b>项目分类</b></span>
                        </li>
                        <li>
                          <a
                            class="show"
