<template>
    <div>
      ...
      <div class="container-fluid support-ticket-section" style="padding-top: 40px;">
        <div class="row">
          <div class="col-md-12">
                      ...
                      <div class="card-body support-ticket-font">
                        <div class="row">
                          <div class="col-5">
                            ...
                            <h5 class="total-num counter">交流会</h5>
                          </div>
                          <div class="col-7">
                    ...
                    <div class="card ecommerce-widget">
                      <div class="card-body support-ticket-font">
                        <div class="row">
                          <div class="col-5">
                            <span>Level 0 -> Level 1</span>
                            <h5 class="total-num counter">真人打 Call</h5>
                          </div>
                          <div class="col-7">
                            <div class="text-md-right">
                              <ul>
                    ...
                    <div class="card ecommerce-widget">
                      <div class="card-body support-ticket-font">
                        <div class="row">
                          <div class="col-5">
                            <span>Level 0 -> Level 1</span>
                            <h5 class="total-num counter">一对一交流</h5>
                          </div>
                          <div class="col-7">
                            <div class="text-md-right">
                              <ul>
