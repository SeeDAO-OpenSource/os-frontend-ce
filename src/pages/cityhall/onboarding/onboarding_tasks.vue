                  ...
                  <b-tabs content-class="mt-3">
                    <b-tab active>
                      <template v-slot:title>
                        <feather type="target"></feather> L0 贡献者
                      </template>
                      <b-card-text>
                        <div class="col-sm-12 p-0">
                          <div class="card">
                    ...
                    <b-tab>
                      <template v-slot:title>
                        <feather type="info"></feather> L1 贡献者
                      </template>  
                      <b-card-text>
                        <div class="col-sm-12 p-0">
                          <div class="card">
                    ...
                    <b-tab>
                      <template v-slot:title>
                        <feather type="check-circle"></feather> L2 贡献者
                      </template> 
                      <b-card-text>
                        <div class="col-sm-12 p-0">
                          <div class="card">
                      ...
                      <template v-slot:title>
                        <feather type="check-circle"></feather> L3 贡献者
                      </template> 
                      <b-card-text>
                        <div class="col-sm-12 p-0">
                          <div class="card">
                    ...
                    <b-tab>
                      <template v-slot:title>
                        <feather type="check-circle"></feather> L4 贡献者
                      </template> 
                      <b-card-text>
                        <div class="col-sm-12 p-0">
                          <div class="card">
                    ...
                    <b-tab>
                      <template v-slot:title>
                        <feather type="check-circle"></feather> L5 贡献者
                      </template> 
                      <b-card-text>
                        <div class="col-sm-12 p-0">
                          <div class="card">
                ...
                <div class="col-sm-6 create-project-btn">
                  <div class="text-right">
                    ...
                    <router-link to="create-project"><a class="btn btn-primary" href="">
                      <i data-feather="plus-square"> </i>添加引导记录</a
                    ></router-link>
                  </div>
                </div>
              </div>
