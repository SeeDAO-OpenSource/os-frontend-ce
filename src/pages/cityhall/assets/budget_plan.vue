<template>
                      ...
                      <ul class="nav main-menu" role="tablist">
                        <li class="nav-item">
                          <div>
                            ...
                            >
                              <feather class="mr-2" type="flag"></feather>
                              召开联席会议
                            </button>
                            <b-modal
                              id="bv-modal-example"
  ...
  <button class="btn btn-primary" type="button" data-dismiss="modal">Cancel</button>
                        ...
                        <li class="nav-item">
                          <span class="main-title"><b>支出项目</b></span>
                        </li>
                        <li>
                          <a
                        ...
                        <li>
                          <span class="main-title"> <b>季度</b></span>
                        </li>
                        <li>
                          <a
                            class="show"
                                ...
                                <div class="col-xl-3 col-md-4 xl-50">
                                  ...
                                  >
                                    <div class="details-website">
                                      ...
                                      <div class="desciption-data">
                                        <div class="title-bookmark">
                                          <h6 class="title_0">Project 123</h6>
                                          <p class="weburl_0">
                                            http://admin.pixelstrap.com/SeeDAO/ltr/landing-page.html
                                          </p>
                                          <div class="hover-block">
                                            <ul>
                                              <li>
