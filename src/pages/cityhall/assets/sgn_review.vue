<template>
                    ...
                    <div class="email-app-sidebar left-bookmark">
                      <div class="media">
                        <div class="media-body ml-1">
                          <h6 class="f-w-600">目前待审批的 SGN 申请</h6>
                          <h3>5</h3>
                        </div>
                      </div>
  ...
  <button class="btn btn-primary" type="button" data-dismiss="modal">Cancel</button>
                        ...
                        <li class="nav-item">
                          <span class="main-title"><b> SGN 申请</b></span>
                        </li>
                        <li>
                          <a
                        ...
                        <li>
                          <span class="main-title"> <b> SGN 来源</b></span>
                        </li>
                        <li>
                          <a
                            class="show"
