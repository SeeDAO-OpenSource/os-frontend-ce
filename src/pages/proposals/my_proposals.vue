<template>
                    ...
                    <ul class="nav main-menu" role="tablist">
                      <li class="nav-item">
                        <div>
                          ...
                          >
                            <feather class="mr-2" type="send"></feather>
                            向他人发送提案请求
                          </button>
                          <b-modal
                            id="bv-modal-example"
  ...
  <button class="btn btn-primary" type="button" data-dismiss="modal">Cancel</button>
                      ...
                      <li class="nav-item">
                        <span class="main-title"><b>我的提案</b></span>
                      </li>
                      <li>
                        <a
