        ...
        <div class="card-header">
          ...
          <div class="row">
            <div class="col-xl-4 col-sm-12">
              <label for="inputState">选择模版</label>
              ...
              <div class="col-xl-4 col-sm-12">
                ...
                <div class="form-group">
                  ...
                  <input
                    ...
                    class="form-control"
                    :class="{
                      'is-invalid': submitted && errors.has('pincode')
                    }"
                  />
                </div>
              </div>
              <div class="col-xl-8 col-sm-12">
                <div class="checkout-details">
                  <div class="order-box">
                    ...
                    <ul class="qty" v-if="!cart.length">
                      <li v-if="!cart.length">Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah </li>
                      <br/>
                      <li v-if="!cart.length">Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah </li>
                      <br/>
                      <li v-if="!cart.length">Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah </li>
                    ...
                    <ul class="sub-total">
                      <li>
                        申请积分 :
                        <span class="count">123 $SCR</span>
                      </li>
                    </ul>
                    <ul class="sub-total">
                      <li>
                        申请 U :
                        <span class="count">30 U</span>
                      </li>
                    </ul>
